  ...
  return (
      <form className="flex small:w-full rounded z-5 font-mont"
        ...
        <input
            ...
            className=" sm:w-[40%] small:w-[150px] small:p-2 small:flex-grow text-xs small:text-sm xl:text-base small:flex-shrink small:border-r border border-r-0 text-black rounded-l"
            required={true}
        />
        ...
        <input
            ...
            className="sm:w-[40%] small:w-[150px] small:p-2 small:flex-grow text-xs small:text-sm xl:text-base small:flex-shrink small:border-r border border-r-0 text-black"
        />
