...
export default function Footer(){
  return (
        <div className={"grid grid-cols-1 lg:grid-cols-3 bg-transparent p-5 text-center"}>
          <div className={"grid grid-rows-3 rounded-3xl m-5 bg-[url('../public/images/soho.webp')] bg-cover overflow-x-hidden shadow-xl shadow-black"}>
          ...
          <div className={"grid grid-rows-3 rounded-3xl m-5 bg-[url('../public/images/toronto.webp')] bg-cover overflow-x-hidden shadow-xl shadow-black"}>
          ...
          <div className={"grid grid-rows-3 rounded-3xl m-5 bg-[url('../public/images/honolulu.webp')] bg-cover overflow-x-hidden shadow-xl shadow-black"}>
